...
#------------------------------- SETUP -------------------------------
# Utilities
var Utils = preload("res://ADDONS/addons/godot_super-wakatime/utils.gd").new()
var DecompressorUtils = preload("res://ADDONS/addons/godot_super-wakatime/decompressor.gd").new()
...
var ApiKeyPrompt: PackedScene = preload("res://ADDONS/addons/godot_super-wakatime/api_key_prompt.tscn")
var Counter: PackedScene = preload("res://ADDONS/addons/godot_super-wakatime/counter.tscn")
